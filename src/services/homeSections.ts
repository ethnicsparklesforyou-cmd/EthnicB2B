...
/**
 * Fetch all curated home screen sections in a single request for B2B app
 * @param appType 'retail' | 'b2b' | 'both'
 */
export async function fetchAllHomeSections(appType: string = 'b2b'): Promise<HomeSectionsMap | null> {
  try {
